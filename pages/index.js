...
export default function IndexPage() {
  return (
    <Container>
      <Head>
        <title>Home</title>
        <meta name="description" content="Universal VR bridges the gap between end users with accessibility needs and VR developers." />
      </Head>
      <HeroSection alt="Woman playing VR in a wheelchair" filename="stock-01.jpg" header="Universal VR" />

      <P>The universalvr.org website was created to bridge the gap between end users with accessibility needs and VR developers.</P>
      ...
      <List>
        ...
        <ListItem>
          <Link href="/users/stories">
            <a aria-label="Form to submit your own story; link opens in a new tab." href="https://forms.gle/MEYJRuuWJxuTcG4u8" target="_blank">Share your story</a>
          </Link>
        </ListItem>
      </List>
    </Container>
